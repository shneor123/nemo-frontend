...
export function ShareModal() {
    ...
    return (
        <section className='share-card'>
            ...
            <input type="text" autofocus className="custom-input" value={`https://nemo-backend-xcav.onrender.com/`} />
            <div className="share-btn-container">
                <a className="facebook" href={`https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fnemo-backend-xcav.onrender.com %2F%23%2Fboard%2F%2Fedit`} target="_blank">
                    <i className="fab fa-facebook-f"></i>Facebook
                </a>
                <a className="whatsapp" href={`https://wa.me/?text=https://nemo-backend-xcav.onrender.com/`} target="_blank" data-action="share/whatsapp/share">
            ...
            {isQRShown && <section className="QRShown flex justify-center" ref={qrRef}>
                <div className="qr-code">
                    {/* <QRCode size={80} value={`https://nemo-backend-xcav.onrender.com/`} /> */}
                </div>
