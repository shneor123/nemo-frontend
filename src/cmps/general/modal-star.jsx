...
export const ModalStar = () => {
  ...
  return (
    <div className='filter'>
      ...
      <button onClick={() => onToggleModal('recent')} className='recent'
      >
        {modalType === 'recent' && <DynamicFilter
          boards={recentBoards}
          modalType={modalType}
          toggleStar={toggleStar} setModal={setModal}
        />
        }
        Recent
      ...
      >
        {modalType === 'starred' && <DynamicFilter
