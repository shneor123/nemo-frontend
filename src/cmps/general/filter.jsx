...
export const Filter = ({ miniBoards, toggleStar }) => {
    ...
    return <div className='filter'>
        <button
         onClick={() => onToggleModal('recent')} 
         className='recent'
         >
            {/* {modalType === 'recent' && <DynamicFilter boards={recentBoards} modalType={modalType} toggleStar={toggleStar} setModal={setModal} />} */}
        ...
        <button
         onClick={() => onToggleModal('starred')} 
         className='stared'
         >
            {/* {modalType === 'starred' && <DynamicFilter boards={starredBoards} modalType={modalType} toggleStar={toggleStar} setModal={setModal} />} */}
            Stared
